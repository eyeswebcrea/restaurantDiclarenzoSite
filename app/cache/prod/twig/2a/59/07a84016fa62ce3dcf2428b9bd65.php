...
class __TwigTemplate_2a5907a84016fa62ce3dcf2428b9bd65 extends Twig_Template
{
    ...
    public function block_stylesheets($context, array $blocks = array())
    {
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "5dda2a4_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_5dda2a4_0") : $this->env->getExtension('assets')->getAssetUrl("css/contact_contact_1.css");
            // line 7
            echo "        \t\t
        ...
        ";
            ...
            // asset "5dda2a4"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_5dda2a4") : $this->env->getExtension('assets')->getAssetUrl("css/contact.css");
            // line 7
            echo "        \t\t
        \t<link rel=\"stylesheet\" href=\"";
            // line 8
...
\t\t\t\t";
            // line 47
            if (isset($context["article"])) { $_article_ = $context["article"]; } else { $_article_ = null; }
            echo $this->env->getExtension('SpipAccesContent')->twig_nl2br_filter($this->getAttribute($_article_, "texte"));
            echo "
\t\t\t</div>
\t\t";
        }
