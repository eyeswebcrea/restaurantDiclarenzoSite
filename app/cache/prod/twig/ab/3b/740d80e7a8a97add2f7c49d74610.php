...
\t    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "78c7f0c_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_78c7f0c_0") : $this->env->getExtension('assets')->getAssetUrl("css/lacarte_lacarte_1.css");
            // line 9
            echo "        \t\t
        ...
        ";
            ...
            // asset "78c7f0c"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_78c7f0c") : $this->env->getExtension('assets')->getAssetUrl("css/lacarte.css");
            // line 9
            echo "        \t\t
        \t<link rel=\"stylesheet\" href=\"";
            // line 10
...
\t\t";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "39728f9_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_39728f9_0") : $this->env->getExtension('assets')->getAssetUrl("js/lacarte_lacarte_1.js");
            // line 20
        ...
        ";
            ...
            // asset "39728f9"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_39728f9") : $this->env->getExtension('assets')->getAssetUrl("js/lacarte.js");
            echo "        \t<script type=\"text/javascript\" src=\"";
            if (isset($context["asset_url"])) { $_asset_url_ = $context["asset_url"]; } else { $_asset_url_ = null; }
            echo twig_escape_filter($this->env, $_asset_url_, "html", null, true);
            echo "\"></script>
 ...
 \t\t\t\t";
   ...
   \t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["pizza"]) {
            // line 32
            echo "   \t\t\t";
            if (isset($context["pizza"])) { $_pizza_ = $context["pizza"]; } else { $_pizza_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->env->getExtension('SpipAccesContent')->boucleArticles(array("idRubrique" => $this->getAttribute($_pizza_, "getIdRubrique", array(), "method")), array("titre" => "ASC")));
            $context['loop'] = array(
   ...
   \t\t\t\t\t\t";
                // line 36
                if (isset($context["menu"])) { $_menu_ = $context["menu"]; } else { $_menu_ = null; }
                echo $this->getAttribute($_menu_, "getTexte", array(), "method");
                echo "
   \t\t\t\t\t</div>
   \t\t\t\t</div>
   \t\t\t";
...
<div class=\"span-22 prepend-1 prepend-top\" id=\"nos-pates\">
 \t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rubrique"]) {
            ...
            echo " <img src=\"";
            if (isset($context["rubrique"])) { $_rubrique_ = $context["rubrique"]; } else { $_rubrique_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->env->getExtension('image')->image($this->getAttribute($_rubrique_, "getPathAbsoluteLocalLogo", array(), "method")), "forceResize", array(0 => 300, 1 => 100), "method"), "html", null, true);
            echo "\" alt=\"";
            if (isset($context["rubrique"])) { $_rubrique_ = $context["rubrique"]; } else { $_rubrique_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_rubrique_, "getTitre", array(), "method"), "html", null, true);
            echo "\"></h2>
   \t\t\t\t\t<p class=\"garniture\"> ";
            // line 47
            if (isset($context["rubrique"])) { $_rubrique_ = $context["rubrique"]; } else { $_rubrique_ = null; }
            echo $this->getAttribute($_rubrique_, "getTexte", array(), "method");
            echo " </p>
   \t\t\t\t";
        }
        $_parent = $context['_parent'];
   ...
   \t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["pates"]) {
            // line 52
            echo "   \t\t\t\t";
            if (isset($context["pates"])) { $_pates_ = $context["pates"]; } else { $_pates_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->env->getExtension('SpipAccesContent')->boucleArticles(array("idRubrique" => $this->getAttribute($_pates_, "getIdRubrique", array(), "method")), array("titre" => "ASC")));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
 ...
 \t\t\t\t";
   ...
   \t\t\t\t\t\t<img src=\"";
            // line 99
            if (isset($context["menu"])) { $_menu_ = $context["menu"]; } else { $_menu_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->env->getExtension('image')->image($this->getAttribute($_menu_, "getPathAbsoluteLocalLogo", array(), "method")), "resize", array(0 => 800, 1 => 1080), "method"), "html", null, true);
            echo "\" alt=\"";
            if (isset($context["menu"])) { $_menu_ = $context["menu"]; } else { $_menu_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_menu_, "getTitre", array(), "method"), "html", null, true);
            echo "\">
   \t\t\t\t\t\t";
            // line 100
            if (isset($context["menu"])) { $_menu_ = $context["menu"]; } else { $_menu_ = null; }
            echo $this->env->getExtension('SpipAccesContent')->twig_nl2br_filter($this->getAttribute($_menu_, "getTexte", array(), "method"));
            echo "
   \t\t\t\t\t</div>
   \t\t\t\t</div>
   \t\t\t";
 ...
 \t\t\t\t";
   ...
   \t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["aperitif"]) {
            // line 255
            echo "   \t\t\t\t";
            if (isset($context["aperitif"])) { $_aperitif_ = $context["aperitif"]; } else { $_aperitif_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->env->getExtension('SpipAccesContent')->boucleArticles(array("idRubrique" => $this->getAttribute($_aperitif_, "getIdRubrique", array(), "method")), array("titre" => "ASC")));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
 ...
 \t\t\t\t";
   ...
   \t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["plat"]) {
            // line 277
            echo "   \t\t\t\t";
            if (isset($context["plat"])) { $_plat_ = $context["plat"]; } else { $_plat_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->env->getExtension('SpipAccesContent')->boucleArticles(array("idRubrique" => $this->getAttribute($_plat_, "getIdRubrique", array(), "method")), array("titre" => "ASC")));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
