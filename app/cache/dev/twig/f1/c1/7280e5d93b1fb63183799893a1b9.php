...
";
    ...
    public function block_list($context, array $blocks = array())
    {
        ...
        if ((($this->getAttribute($this->getContext($context, "item"), "hasChildren") && (!($this->getAttribute($this->getContext($context, "options"), "depth") === 0))) && $this->getAttribute($this->getContext($context, "item"), "displayChildren"))) {
            // line 22
            echo "    <ul";
            echo twig_escape_filter($this->env, $this->getAttribute($this, "attributes", array(0 => $this->getContext($context, "listAttributes")), "method"), "html", null, true);
            echo ">
        ";
            // line 23
            $this->displayBlock("children", $context, $blocks);
...
";
    ...
    public function block_linkElement($context, array $blocks = array())
    {
        ...
        echo "\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this, "attributes", array(0 => $this->getAttribute($this->getContext($context, "item"), "linkAttributes")), "method"), "html", null, true);
        echo ">";
        $this->displayBlock("label", $context, $blocks);
        echo "</a>";
    }
    ...
    {
        echo "<span";
        echo twig_escape_filter($this->env, $this->getAttribute($this, "attributes", array(0 => $this->getAttribute($this->getContext($context, "item"), "labelAttributes")), "method"), "html", null, true);
        echo ">";
        $this->displayBlock("label", $context, $blocks);
        echo "</span>";
    }
