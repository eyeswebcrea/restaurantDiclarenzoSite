...
class __TwigTemplate_254742d46a9aedf06cd43c0f75f249f9 extends Twig_Template
{
    ...
    <div id=\"content\">
        ...
        if ($this->getContext($context, "profile")) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('SpipAccesContent')->twig_date_filter($this->getAttribute($this->getContext($context, "profile"), "time"), "r"), "html", null, true);
            echo "</strong>
                    </span>
                </p>
            </div>
