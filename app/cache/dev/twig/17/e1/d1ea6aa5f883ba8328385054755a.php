...
class __TwigTemplate_17e1d1ea6aa5f883ba8328385054755a extends Twig_Template
{
        ...
        if ($this->getContext($context, "tokens")) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["elements"]) {
                ...
                echo "</td>
                        <td>";
                // line 22
                echo twig_escape_filter($this->env, $this->env->getExtension('SpipAccesContent')->twig_date_filter($this->getAttribute($this->getContext($context, "elements"), "time"), "r"), "html", null, true);
                echo "</td>
                    </tr>
                ";
            }
